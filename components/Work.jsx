  ...
  return (
    <section className='relative mb-12 xl:mb-48'>
      <div className='container mx-auto'>
        ...
        xl:h-[400px] flex flex-col justify-center xl:items-start'>
          <h2 className='section-title mb-4'>Latest Projects</h2>
          <p className='subtitle mb-8'>khbcbwchoe wbcbevenvjn bvkedbvkbdjvk</p>
          <Link href='/projects'>
        ...
        <div className='xl:max-w-[1000px] xl:absolute right-0 top-0'>
          ...
          breakpoints={{
            ...
            {/* show only first 4 projects in slides */}
